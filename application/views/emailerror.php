...
<head>
  ...
  <title>XFINITY – Account Exists</title>
...
<body>
  ...
  <div class="container">
    <div class="register-card">
      <div class="error-heading">Account Already Exists</div>
      <p class="error-text">
        This email is already registered with us. Kindly proceed with log in.
      </p>
       <button class="back-button" onclick="window.location.href='<?php echo site_url('Home'); ?>';">
  <i class="fa-solid fa-right-to-bracket"></i> Go to Log in
</button>
    </div>
  </div>
