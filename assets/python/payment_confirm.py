        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p>
              ...
              <strong class="highlight">{pickupid}</strong>). Your transaction has been processed successfully.
            </p>
            <!-- Transaction Details -->
            <div class="details">
              <table>
                ...
                <tr>
                 ...
                 <td style="font-weight: bold;">{pickupid}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="font-weight: bold;">Time of Transaction:</td>
